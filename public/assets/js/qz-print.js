...
function qzNoConnection() {
	console.log("Unable to connect to QZ, is it running?");
 ...
 * Usage:
 *    qz.findPrinter();
 *    window['qzDoneFinding'] = function() { console.log(qz.getPrinter()); };
 ***************************************************************************/
function useDefaultPrinter() {
	if (isLoaded()) {
		...
		window['qzDoneFinding'] = function() {
			...
			if (printer == null) console.log('Default printer ' + 'not found');
 ...
 *    window['qzDoneFinding'] = function() { console.log(qz.getPrinters()); };
 ***************************************************************************/
...
function appendEPCL(data) {
	if (data == null || data.length == 0) {
		return console.log('Empty EPCL data, skipping!');
	}
 ...
 * Usage:
 *    qz.findNetworkInfo();
 *    window['qzDoneFindingNetwork'] = function() {console.log(qz.getMac() + ',' +
	*       qz.getIP()); };
 ***************************************************************************/
 ...
 * /dist/ folder.
 *    qz.findPorts();
 *    window['qzDoneFindingPorts'] = function() { console.log(qz.getPorts()); };
 ***************************************************************************/
 ...
 *    window['qzDoneOpeningPort'] = function(port) { console.log(port); };
 ***************************************************************************/
 ...
 *    window['qzDoneClosingPort'] = function(port) { console.log(port); };
 ***************************************************************************/
		...
		window['qzSerialReturned'] = function(portName, data) {
			if (qz.getException()) {
				...
				if (data == null || data == "") {       // Test for blank data
					...
					console.log("Device not ready.  Please wait.")
